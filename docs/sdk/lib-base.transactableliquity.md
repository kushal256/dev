...
|  [approveCollateral(allowance)](./lib-base.transactableliquity.approvecollateral.md) | Allow Liquity to use the collateral token. [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
