...
def logGlobalState(contracts):
    ...
    activePoolColl = contracts.activePool.getCollateral()
    activePoolDebt = contracts.activePool.getDebt()
    defaultPoolColl = contracts.defaultPool.getCollateral()
    defaultPoolDebt = contracts.defaultPool.getDebt()
